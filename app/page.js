...
export default function LandingPage() {
  ...
  const redirectToAuth = () =>
    (window.location.href = "https://airecruiter-app.vercel.app/auth");
    ...
    <div className="w-full bg-white text-black">
      ...
      <section className="flex flex-col-reverse lg:flex-row items-center justify-between px-6 py-3 bg-gradient-to-br from-white to-gray-50 gap-10">
        ...
        <div className="w-full lg:w-1/3 space-y-6">
          ...
          <div className="flex gap-4">
            <Button onClick={redirectToAuth}>Create Interview</Button>
      ...
      <section className="py-16 px-6 text-center">
        ...
        <div className="flex justify-center gap-4">
          <Button onClick={redirectToAuth}>Get Started for Free</Button>
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button variant="outline">Watch Demo</Button>
            </DialogTrigger>
